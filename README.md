...
Next, you must open directory [OOP_lesson_1/Lesson_1/Win32/Debug/](https://github.com/vastXgithub/OOP_lesson_1/tree/master/Lesson_1/Win32/Debug) on your local version (that is what you downloaded) and double-click on console_app.exe. **Profit!!!**
...
Затем вы должны открыть каталог [OOP_lesson_1/Lesson_1/Win32/Debug/](https://github.com/vastXgithub/OOP_lesson_1/tree/master/Lesson_1/Win32/Debug) в вашей локальной версии (это то, что вы загрузили) и дважды щелкните на console_app.exe. **Профит!!!**
